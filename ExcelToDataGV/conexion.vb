...
Public Class conexion
    ...
    Public Shared Function conection() As MySqlConnection
        ...
        Return con
    End Function
    'Agregar el excel a la base de datos
    Public Shared Sub addvalue(ByVal p1 As String, p2 As String, p3 As String, p4 As String, p5 As String, p6 As String, p7 As String, p8 As String, p9 As String, p10 As String, p11 As String, p12 As String, p13 As String, p14 As String, p15 As String, p16 As String, p17 As String, p18 As String, p19 As String, p20 As String, p21 As String, p22 As String, p23 As String, p24 As String, p25 As String, p26 As String)
        ...
        con.Close()
    End Sub
    'Verificar si ya existe el periodo que se quiere insertar dentro de la base de datos
    ...
    Public Shared Function getNombres() As DataTable
        ...
        Return dt
    End Function
    'Algoritmo para realizar busquedas dento del mismo mes (Ejem: Jun2018 a Jun2018)
    Public Shared Function getCampos2() As DataTable
        ...
        Return dt
    End Function
    Public Shared Function getLastSueldo() As String
        Dim nombre As String = ""
        Dim lastSueldo As String = ""
        Dim periodo As String = Compautos.mesFin & Compautos.yearFinal
        nombre = Compautos.nombre
        Dim con As MySqlConnection = conexion.conection
        Dim cmd As MySqlCommand = New MySqlCommand(String.Format("select sueldoDiario from compautos_nomina where nombre ='" + nombre + "' and periodo='" + periodo + "'  ORDER by periodo desc LIMIT 1"), con)
        Dim reader As MySqlDataReader = cmd.ExecuteReader
        If reader.Read() Then
            lastSueldo = reader(0).ToString()
        End If
        con.Close()
        Return lastSueldo

    End Function
    'ALgoritmo para las demas busquedas
